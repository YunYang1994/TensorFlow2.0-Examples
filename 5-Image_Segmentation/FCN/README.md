## [FCN: Fully Convolutional Networks for Semantic Segmentation](https://github.com/YunYang1994/ai-notebooks/blob/master/FCN.md)
--------------------
...
```
Then you need parser_voc.py to parser PASCAL VOC dataset and train it. Finally you can evaluate model by `python test.py`. The prediction results are expected to save in `./data/prediction`. Here is my trained weight [FCN8s.h5](https://github.c)
